...
public:
    ...
    void setupUi(QWidget *grafi_empleados)
    {
        ...
        grafi_empleados->resize(317, 337);
        layoutWidget = new QWidget(grafi_empleados);
        layoutWidget->setObjectName("layoutWidget");
        layoutWidget->setGeometry(QRect(20, 10, 281, 311));
        QFont font;
    ...
    {
        grafi_empleados->setWindowTitle(QCoreApplication::translate("grafi_empleados", "Empleados", nullptr));
